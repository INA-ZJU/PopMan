  ...
  render() {
    ...
    return (
        <View className='selectPhotoPage'>
          <View className='selectedPhotoRegion' style={{backgroundImage: `url(${picUrl})`}}>
          </View>
          <Image onClick={this.cancelSelect.bind(this)} className='cancelButton' src='https://user-images.githubusercontent.com/37944486/50434372-e86f0b00-0917-11e9-818e-78c25ea116f0.png' />
          <Image  onClick={this.confirmSelect.bind(this,{param: picUrl})} className='confirmButton' src='https://user-images.githubusercontent.com/37944486/50434382-e907a180-0917-11e9-932f-388062017dc4.png' />
        </View>
    );
  }
}
